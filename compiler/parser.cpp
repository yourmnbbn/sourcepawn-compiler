...
inst_datetime_defines(void) {
    ...
    insert_subst("__SP_COMPILER_STRIP_AND_PROTECTION__", 36, "");
}
...
static void
setcaption(void) {
    pc_printf("SourcePawn Compiler %s Strip and Anti-decompiler by yourmnbbn\n", SOURCEPAWN_VERSION);
...
about(void) {
    ...
    pc_printf("             1    JIT-compatible optimizations only\n");
        ...
        pc_printf("         -s       strip debug symbols\n");
        pc_printf("         -P       enable anti-decompiler protection\n");
